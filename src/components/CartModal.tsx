                  ...
                  >
                    <div className="flex p-3">
                      ...
                      <div className="ml-4 flex-grow">
                        ...
                        <p className="text-sm text-gray-500 line-clamp-1 mb-2">{item.categoria}</p>
          ...
          >
            ...
            <div className="space-y-2">
              ...
              {cartItems.length > 0 && (
                <button
                  onClick={clearCart}
                  className="w-full bg-white hover:bg-gray-100 text-gray-600 py-2 border border-gray-300 rounded-lg transition-all duration-300 text-sm"
                >
                  Limpar Carrinho
                </button>
              )}
